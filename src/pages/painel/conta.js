            ...
            <div className="flex flex-col md:flex-row justify-start items-start gap-6 py-6">
                ...
                <div className="w-full md:w-[60%] flex flex-col gap-6">
                    ...
                    <div className="w-full flex flex-col xl:flex-row items-center gap-6">
                        ...
                        <div className="w-full flex flex-row items-center px-4 py-3 gap-4 bg-neutral-100 rounded-md smooth-slide-down-fade-in opacity-0" style={{ animationDelay: "700ms" }}>
                    ...
                    <form onSubmit={handleUserUpdateSubmit} className="w-full flex flex-col gap-5 px-4 py-5 bg-neutral-100 rounded-md smooth-slide-down-fade-in opacity-0" style={{ animationDelay: "1000ms" }}>
                ...
                <div className="w-full md:w-[40%] flex flex-col gap-6">
                    ...
                    <form onSubmit={handlePasswordUpdateSubmit} className="w-full flex flex-col items-start justify-start px-4 py-5 bg-neutral-100 rounded-md smooth-slide-down-fade-in opacity-0" style={{ animationDelay: "1200ms" }}>
                    ...
                    <form className="w-full flex flex-col items-start justify-start px-4 py-5 bg-neutral-100 rounded-md smooth-slide-down-fade-in opacity-0" style={{ animationDelay: "1400ms" }}>
