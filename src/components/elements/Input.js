...
export function BasicInput({ name, label, placeholder, type, onChange, defaultValue, error }) {

    return (
        <div className="w-full flex flex-col gap-1">
            <div className={input.basicInputDiv}>
                <input onChange={onChange} className={input.basicInput} style={error ? { borderColor: "red" } : null } id={name} name={name} type={type} placeholder={placeholder} defaultValue={defaultValue}></input>
...
export function AdvancedInput({ name, label, type, onChange, defaultValue, error, bgColor }) {

    return (
        <div className="w-full flex flex-col gap-1">
            <div className={input.advancedInputDiv}>
                <input onChange={onChange} className={input.advancedInput} style={error ? { borderColor: "red" } : null } id={name} name={name} type={type} placeholder=" " defaultValue={defaultValue}></input>
