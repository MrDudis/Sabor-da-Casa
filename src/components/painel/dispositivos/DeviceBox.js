...
export default function DeviceBox({ device }) {
    ...
    if (!device) {
        return (
            <div className="w-full min-w-[124px] h-24 flex flex-col xs:flex-row items-center px-4 py-4 border border-neutral-400 transition-all bg-neutral-100 gap-6 rounded-lg shimmer smooth-slide-down-fade-in opacity-0">
    ...
    return (
        <div href={`/painel/dispositivos/${device?.id}`} className="w-full min-w-[124px] h-24 flex flex-col xs:flex-row items-center gap-8 px-4 py-4 border border-neutral-400 transition-all bg-neutral-100 rounded-lg fast-fade-in opacity-0" style={{ animationDelay: "400ms" }}>
            ...
            <div className="w-full h-full flex flex-row justify-start items-center gap-4">
                ...
                <div className="flex flex-col justify-center items-start text-center gap-1">
                    ...
                    <div className="flex flex-row items-center gap-1.5">
                        <p className="w-full h-full text-black font-lgc font-bold text-lg truncate-2-line">Dispositivo Desconhecido</p>
                    ...
                    <div className="flex flex-row items-center gap-1.5">
                        ...
                        <p className="text-black font-lgc text-sm">{device?.userId ? device?.user?.name : "Despareado"}</p>
                    </div>
