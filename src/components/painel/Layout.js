    ...
    return (
        <div className="flex w-full h-full mt-8 2xs:mt-0">
            ...
            <div className={styles.sidebar}>
                ...
                <div className="w-full h-full sm:h-auto flex flex-row sm:flex-col items-center justify-center sm:items-start sm:justify-start gap-0">
                    ...
                    <Link href="/painel/pedidos" className={styles.sidebarLink} style={{ backgroundColor: activePage == "Meus Pedidos" ? "rgb(52, 52, 52)" : "" }}>
                        ...
                        <p className={styles.sidebarLinkText}>Meus Pedidos</p>
                    ...
                    <Link href="/painel/comandas" className={styles.sidebarLink} style={{ backgroundColor: activePage == "Comandas" ? "rgb(52, 52, 52)" : "" }}>
                    ...
                    <Link href="/painel/conta" className={styles.sidebarLinkMobileOnly} style={{ backgroundColor: activePage == "Minha Conta" ? "rgb(52, 52, 52)" : "" }}>
                        ...
                        <p className={styles.sidebarLinkText}>Minha Conta</p>
                ...
                <Link href="/painel/conta" className="w-full min-h-[64px] px-6 mt-8 hidden sm:flex flex-row items-center justify-start gap-4 cursor-pointer hover:bg-neutral-800 transition-all" style={{ backgroundColor: activePage == "Minha Conta" ? "rgb(52, 52, 52)" : "" }}>
                    ...
                    <div className="hidden lg:flex flex-col items-start justify-center">
                        ...
                        <p className="text-white text-sm font-lgc">{user?.name}</p>
                    </div>
                </Link>
