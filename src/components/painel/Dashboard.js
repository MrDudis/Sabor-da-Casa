...
import styles from "@/styles/components/painel/Sidebar.module.css";
        ...
        <div className="flex w-full h-full">
            ...
            <div className={styles.sidebar}>
                ...
                <div className="w-full h-full sm:h-auto flex flex-row sm:flex-col items-center justify-center sm:items-start sm:justify-start gap-2 sm:py-4 sm:border-t sm:border-b sm:border-neutral-600">
                    ...
                    <Link href="/painel" className={styles.sidebarLink} style={{ backgroundColor: activePage == "Início" ? "rgb(52, 52, 52)" : "" }}>
                    ...
                    <Link href="/painel/produtos" className={styles.sidebarLink} style={{ backgroundColor: activePage == "Produtos" ? "rgb(52, 52, 52)" : "" }}>
                    ...
                    <Link href="/painel/pessoas" className={styles.sidebarLink} style={{ backgroundColor: activePage == "Pessoas" ? "rgb(52, 52, 52)" : "" }}>
                    ...
                    <Link href="/painel/cartoes" className={styles.sidebarLink} style={{ backgroundColor: activePage == "Cartões" ? "rgb(52, 52, 52)" : "" }}>
                    ...
                    <Link href="/painel/configuracoes" className={styles.sidebarLink} style={{ backgroundColor: activePage == "Configurações" ? "rgb(52, 52, 52)" : "" }}>
                        ...
                        <p className={styles.sidebarLinkText}>Configurações</p>
                ...
                <div className="w-full min-h-[86px] hidden sm:flex flex-col items-center justify-end gap-1">
                    <p className="font-lgc text-neutral-400 text-xs text-center">Copyright © 2023</p>
                    <p className="font-lgc text-neutral-400 text-xs text-center hidden lg:block">Todos os direitos reservados.</p>
                </div>
            ...
            <div className="flex w-full fade-in">
                ...
                <div className="w-full pb-24 sm:pb-0 p-6 sm:p-10 overflow-auto min-h-screen max-h-screen">

                    <div className="w-[90%] flex flex-col justify-center items-start border-b border-neutral-800">
                        <h1 className="font-lgc text-3xl sm:text-4xl pr-4 pb-3 text-center">{activePage}</h1>
                    </div>
