...
export default function PersonBox({ user, animationDelay }) {
    ...
    return (
        <Link href={`/painel/pessoas/${user?.id}`} className="w-full min-w-[148px] h-52 flex flex-col xs:flex-row items-center gap-8 px-4 py-4 border border-neutral-400 cursor-pointer hover:bg-neutral-50 hover:shadow-xl transition-all bg-neutral-100 rounded-lg fast-fade-in">
